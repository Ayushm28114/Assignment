          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Your trusted partner in IELTS preparation. We help students worldwide achieve their dream band scores through innovative learning methods.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Academic IELTS</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">General Training</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Speaking Practice</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Writing Improvement</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Listening Skills</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Reading Techniques</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-gray-400">info@ieltspro.com</p>
                </div>
              </div>

              {/* Newsletter */}
              <div className="mt-8">
                <h4 className="text-md font-semibold mb-4">Subscribe to Our Newsletter</h4>
                <div className="flex">
                  <input 
                    type="email" 
                  ...
                  />
                  <button 
                    onClick={() => {/* Newsletter subscription would be implemented here */}}
